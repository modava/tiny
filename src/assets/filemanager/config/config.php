...
$akey = md5($_SESSION['userId'] . 'dsDlFWR9M2xQV');
...
$config = array(
    ...
    |
    */
    'base_url' => isset($uploadPath['base_url']) ? $uploadPath['base_url'] : ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http") . "://" . @$_SERVER['HTTP_HOST'],
    /*
    |--------------------------------------------------------------------------
