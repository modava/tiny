...
class TinyMce extends InputWidget {
    ...
    public function init() {
        ...
        TinyMceAsset::register( $this->_view );

        $insFile = FileManagerAsset::register( $this->_view );
        $this->setOptions( $insFile );
    }
    ...
    private function setOptions( $insFile ) {
        ...
        $this->custom_options            = $this->clientOptions;
    ...
    private function getJsRegisterOptions() {
